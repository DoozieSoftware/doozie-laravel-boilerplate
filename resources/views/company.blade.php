                ...
                <div class="px-4 py-4 bg-white sm:p-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input type="number" value="{{$company->phone_no}}" name="phone_no" id="phone_no" 
                                autocomplete="email"
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <textarea type="number" name="address" id="address"
                                autocomplete="family-name"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" disabled>{{$company->address}}</textarea>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <img src="{{$company->getFirstMediaUrl('logo', 'thumb')}}" / width="120px">

                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label for="certificate" class="block text-sm font-medium text-gray-700">Certificate</label>
                            <img src="{{$company->getFirstMediaUrl('certificate', 'thumb')}}" / width="120px">
